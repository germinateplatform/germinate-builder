 ...
 */
@WebServlet(urlPatterns = {"/gatekeeper-progress"})
public class GatekeeperProgressServlet extends HttpServlet
{
	...
	protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException
	{
		...
		if (!StringUtils.isEmpty(uuid))
		{
			...
			File logFile = new File(FileUtils.getTemporaryFileFolder(req, "Gatekeeper"), uuid + ".log");
		...
		if (!StringUtils.isEmpty(GatekeeperBuilderServlet.getError()))
		{
			out.write(GatekeeperBuilderServlet.getError());
			resp.setStatus(HttpServletResponse.SC_INTERNAL_SERVER_ERROR);
		}
		else if (!GatekeeperBuilderServlet.isRunning())
		{
